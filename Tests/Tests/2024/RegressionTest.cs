...
public class RegressionTest
{
    ...
    [Test]
    public void Day05Part1() => new Day05().Part1(_day05Input.Value).Should().Be(4637);
    ...
    [Test]
    public void Day07Part1() => new Day07().Part1(_day07Input.Value).Should().Be(4555081946288);

    [Test]
    public void Day07Part2() => new Day07().Part2(_day07Input.Value).Should().Be(227921760109726);

    [Test]
    public void Day08Part1() => new Day08().Part1(_day08Input.Value).Should().Be(220);

    [Test]
    public void Day08Part2() => new Day08().Part2(_day08Input.Value).Should().Be(813);

    [Test]
    public void Day09Part1() => new Day09().Part1(_day09Input.Value).Should().Be(6301895872542);

    [Test]
    public void Day09Part2() => new Day09().Part2(_day09Input.Value).Should().Be(6323761685944);

    [Test]
    public void Day10Part1() => new Day10().Part1(_day10Input.Value).Should().Be(811);

    [Test]
    public void Day10Part2() => new Day10().Part2(_day10Input.Value).Should().Be(1794);

    [Test]
    public void Day11Part1() => new Day11().Part1(_day11Input.Value).Should().Be(209412);

    [Test]
    public void Day11Part2() => new Day11().Part2(_day11Input.Value).Should().Be(248967696501656);

    [Test]
    public void Day12Part1() => new Day12().Part1(_day12Input.Value).Should().Be(1402544);

    [Test]
    public void Day12Part2() => new Day12().Part2(_day12Input.Value).Should().Be(862486);

    [Test]
    public void Day13Part1() => new Day13().Part1(_day13Input.Value).Should().Be(26599);

    [Test]
    public void Day13Part2() => new Day13().Part2(_day13Input.Value).Should().Be(106228669504887);

    [Test]
    public void Day14Part1() => new Day14().Part1(_day14Input.Value).Should().Be(230900224);

    [Test]
    public void Day14Part2() => new Day14().Part2(_day14Input.Value).Should().Be(6532);

    [Test]
    public void Day15Part1() => new Day15().Part1(_day15Input.Value).Should().Be(1430439);

    [Test]
    public void Day15Part2() => new Day15().Part2(_day15Input.Value).Should().Be(1458740);

    [Test]
    public void Day16Part1() => new Day16().Part1(_day16Input.Value).Should().Be(122492);

    [Test]
    public void Day16Part2() => new Day16().Part2(_day16Input.Value).Should().Be(520);

    [Test]
    public void Day17Part1() => new Day17().Part1(_day17Input.Value).Should().Be("3,7,1,7,2,1,0,6,3");

    [Test]
    public void Day17Part2() => new Day17().Part2(_day17Input.Value).Should().Be("37221334433268");

    [Test]
    public void Day18Part1() => new Day18().Part1(_day18Input.Value).Should().Be("360");

    [Test]
    public void Day18Part2() => new Day18().Part2(_day18Input.Value).Should().Be("58,62");

    [Test]
    public void Day19Part1() => new Day19().Part1(_day19Input.Value).Should().Be(327);

    [Test]
    public void Day19Part2() => new Day19().Part2(_day19Input.Value).Should().Be(772696486795255);
