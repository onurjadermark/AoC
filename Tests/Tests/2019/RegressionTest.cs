...
public class RegressionTest
{
    ...
    [Test]
    public void Day01Part1() => new Day01().Part1(_day01Input).Should().Be(3497998);

    [Test]
    public void Day01Part2() => new Day01().Part2(_day01Input).Should().Be(5244112);

    [Test]
    public void Day02Part1() => new Day02().Part1(_day02Input).Should().Be(3101844);

    [Test]
    public void Day02Part2() => new Day02().Part2(_day02Input).Should().Be(8478);
