...
public class RegressionTest
{
    ...
    [Test]
    public void Day01Part1() => new Day01().Part1(_day01Input.Value).Should().Be(3497998);

    [Test]
    public void Day01Part2() => new Day01().Part2(_day01Input.Value).Should().Be(5244112);

    [Test]
    public void Day02Part1() => new Day02().Part1(_day02Input.Value).Should().Be(3101844);

    [Test]
    public void Day02Part2() => new Day02().Part2(_day02Input.Value).Should().Be(8478);

    [Test]
    public void Day03Part1() => new Day03().Part1(_day03Input.Value).Should().Be(0);

    [Test]
    public void Day03Part2() => new Day03().Part2(_day03Input.Value).Should().Be(0);

    [Test]
    public void Day04Part1() => new Day04().Part1(_day04Input.Value).Should().Be(0);

    [Test]
    public void Day04Part2() => new Day04().Part2(_day04Input.Value).Should().Be(0);
