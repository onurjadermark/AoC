...
{
    private readonly string _sampleInput1 = @"light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.";
    ...
    private readonly string _sampleInput2 = @"shiny gold bags contain 2 dark red bags.
