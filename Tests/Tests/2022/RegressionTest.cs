...
public class RegressionTest
{
    ...
    [Test]
    public void Day08Part1() => new Day08().Part1(_day08Input).Should().Be(1703);

    [Test]
    public void Day08Part2() => new Day08().Part2(_day08Input).Should().Be(496650);

    [Test]
    public void Day09Part1() => new Day09().Part1(_day09Input).Should().Be(6494);

    [Test]
    public void Day09Part2() => new Day09().Part2(_day09Input).Should().Be(2691);

    [Test]
    public void Day10Part1() => new Day10().Part1(_day10Input).Should().Be(11820);

    [Test]
    public void Day10Part2() => new Day10().Part2(_day10Input).Should().Be(@"####.###....##.###..###..#..#..##..#..#.
#....#..#....#.#..#.#..#.#.#..#..#.#..#.
###..#..#....#.###..#..#.##...#..#.####.
#....###.....#.#..#.###..#.#..####.#..#.
#....#....#..#.#..#.#.#..#.#..#..#.#..#.
####.#.....##..###..#..#.#..#.#..#.#..#.");
    ...
    [Test]
    public void Day11Part2() => new Day11().Part2(_day11Input).Should().Be(19754471646);

    [Test]
    public void Day12Part1() => new Day12().Part1(_day12Input).Should().Be(504);

    [Test]
    public void Day12Part2() => new Day12().Part2(_day12Input).Should().Be(500);

    [Test]
    public void Day13Part1() => new Day13().Part1(_day13Input).Should().Be(6484);

    [Test]
    public void Day13Part2() => new Day13().Part2(_day13Input).Should().Be(19305);

    [Test]
    public void Day14Part1() => new Day14().Part1(_day14Input).Should().Be(885);

    [Test]
    public void Day14Part2() => new Day14().Part2(_day14Input).Should().Be(28691);

    [Test]
    public void Day15Part1() => new Day15().Part1(_day15Input).Should().Be(5607466);

    [Test]
    public void Day15Part2() => new Day15().Part2(_day15Input).Should().Be(12543202766584);

    [Test]
    public void Day16Part1() => new Day16().Part1(_day16Input).Should().Be(1595);

    [Test]
    public void Day16Part2() => new Day16().Part2(_day16Input).Should().Be(2189);

    [Test]
    public void Day17Part1() => new Day17().Part1(_day17Input).Should().Be(3227);

    [Test]
    public void Day17Part2() => new Day17().Part2(_day17Input).Should().Be(1597714285698);

    [Test]
    public void Day18Part1() => new Day18().Part1(_day18Input).Should().Be(3374);

    [Test]
    public void Day18Part2() => new Day18().Part2(_day18Input).Should().Be(2010);

    [Test]
    public void Day19Part1() => new Day19().Part1(_day19Input).Should().Be(960);

    [Test]
    public void Day19Part2() => new Day19().Part2(_day19Input).Should().Be(2040);

    [Test]
    public void Day20Part1() => new Day20().Part1(_day20Input).Should().Be(11073);

    [Test]
    public void Day20Part2() => new Day20().Part2(_day20Input).Should().Be(11102539613040);

    [Test]
    public void Day21Part1() => new Day21().Part1(_day21Input).Should().Be(93813115694560);
    ...
    [Test]
    public void Day23Part1() => new Day23().Part1(_day23Input).Should().Be(3815);

    [Test]
    public void Day23Part2() => new Day23().Part2(_day23Input).Should().Be(893);

    [Test]
    public void Day24Part1() => new Day24().Part1(_day24Input).Should().Be(264);

    [Test]
    public void Day24Part2() => new Day24().Part2(_day24Input).Should().Be(789);

    [Test]
    public void Day25Part1() => new Day25().Part1(_day25Input).Should().Be("2-=102--02--=1-12=22");
}