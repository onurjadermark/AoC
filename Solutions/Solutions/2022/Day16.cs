...
public class Day16
{
    ...
    {        
        ...
        var maxReleasedPressure = 0;
        var memo = new Dictionary<string, int>();
        var stack = new Stack<(HashSet<Valve> OpenedValves, Valve Location, Valve ElephantLocation, int Pressure, int Time)>();
        stack.Push((new HashSet<Valve>(), valves.Single(x => x.Name == "AA"), valves.Single(x => x.Name == "AA"), 0, 0));
